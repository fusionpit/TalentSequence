...
local localeText = {
    enUS = {
        ...
        INVALID_LINK = "Sorry, the link appears to be invalid. Please make sure you've expanded the Talent Order panel and copied the entire Wowhead Talent Calculator URL or get one by copying the link below.",
